...
@st.cache_resource
def get_model():
    tokenizer = AutoTokenizer.from_pretrained("/content/ChatGLM2-6B/models", trust_remote_code=True)
    model = AutoModel.from_pretrained("/content/ChatGLM2-6B/models", trust_remote_code=True).cuda()
